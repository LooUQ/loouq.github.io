...
\item 
\mbox{\Hypertarget{ltemc-atcmd_8c_ace6fa4719be9aafa2968680c5ef75ac5}\label{ltemc-atcmd_8c_ace6fa4719be9aafa2968680c5ef75ac5}} 
\#define {\bfseries CTRL}(x)~(\#x\mbox{[}0\mbox{]}-\/\textquotesingle{}a\textquotesingle{}+1)
\item 
...
void \mbox{\hyperlink{ltemc-atcmd_8c_a12f91584f62bec59a930301de9d7956f}{atcmd\+\_\+set\+Data\+Handler}} (stream\+Data\+Rcvr\+\_\+func data\+Receiver)
\begin{DoxyCompactList}\small\item\em Reset AT command options to defaults. \end{DoxyCompactList}\item 
...
void \mbox{\hyperlink{ltemc-atcmd_8c_ad19d2388cd6d4423be873314968de031}{atcmd\+\_\+send\+Cmd\+Data}} (const char $\ast$data, uint16\+\_\+t data\+Sz)
\begin{DoxyCompactList}\small\item\em Performs blind send data transfer to device. \end{DoxyCompactList}\item 
result\+Code\+\_\+t \mbox{\hyperlink{ltemc-atcmd_8c_ac5cd84c5342fb9cd5ebc175a09cb3229}{ATCMD\+\_\+read\+Result}} ()
\begin{DoxyCompactList}\small\item\em Checks receive buffer for command response and sets atcmd structure data with result. \end{DoxyCompactList}\item 
...
\mbox{\hyperlink{ltemc-types_8h_a66c4c183f8908a0fe0928ef236dbccce}{cmd\+Parse\+Rslt\+\_\+t}} \mbox{\hyperlink{ltemc-atcmd_8c_aabe561361875acf197304759838af23a}{ATCMD\+\_\+test\+Response\+Trace}} ()
\begin{DoxyCompactList}\small\item\em LTEmC internal testing parser to capture incoming response until timeout. \end{DoxyCompactList}\item 
\mbox{\hyperlink{ltemc-types_8h_a66c4c183f8908a0fe0928ef236dbccce}{cmd\+Parse\+Rslt\+\_\+t}} \mbox{\hyperlink{ltemc-atcmd_8c_a6276c3a16859ccf82f39f00c42fd3b3b}{ATCMD\+\_\+tx\+Data\+Prompt\+Parser}} ()
...
\mbox{\hyperlink{ltemc-types_8h_a66c4c183f8908a0fe0928ef236dbccce}{cmd\+Parse\+Rslt\+\_\+t}} \mbox{\hyperlink{ltemc-atcmd_8c_a83358a615495d2c3a1f2901756869200}{ATCMD\+\_\+connect\+Prompt\+Parser}} ()
\begin{DoxyCompactList}\small\item\em \char`\"{}\+CONNECT\char`\"{} prompt parser. \end{DoxyCompactList}\item 
\mbox{\hyperlink{ltemc-types_8h_a66c4c183f8908a0fe0928ef236dbccce}{cmd\+Parse\+Rslt\+\_\+t}} \mbox{\hyperlink{ltemc-atcmd_8c_a948a107cb71e1b1df505be4d2a7bbbdd}{ATCMD\+\_\+ready\+Prompt\+Parser}} (const char $\ast$rdy\+Prompt)
...
\hline
\end{DoxyParams}
\mbox{\Hypertarget{ltemc-atcmd_8c_a83358a615495d2c3a1f2901756869200}\label{ltemc-atcmd_8c_a83358a615495d2c3a1f2901756869200}} 
...
\char`\"{}\+CONNECT\char`\"{} prompt parser. 
...
Default AT command result parser. \mbox{\Hypertarget{ltemc-atcmd_8c_ac5cd84c5342fb9cd5ebc175a09cb3229}\label{ltemc-atcmd_8c_ac5cd84c5342fb9cd5ebc175a09cb3229}} 
\index{ltemc-\/atcmd.c@{ltemc-\/atcmd.c}!ATCMD\_readResult@{ATCMD\_readResult}}
\index{ATCMD\_readResult@{ATCMD\_readResult}!ltemc-\/atcmd.c@{ltemc-\/atcmd.c}}
...
Checks receive buffer for command response and sets atcmd structure data with result. 

Checks recv buffer for command response and sets atcmd structure data with result. \mbox{\Hypertarget{ltemc-atcmd_8c_a948a107cb71e1b1df505be4d2a7bbbdd}\label{ltemc-atcmd_8c_a948a107cb71e1b1df505be4d2a7bbbdd}} 
...
\end{DoxyReturn}
\mbox{\Hypertarget{ltemc-atcmd_8c_a6564b7b17223a1e581beef02914406dc}\label{ltemc-atcmd_8c_a6564b7b17223a1e581beef02914406dc}} 
...
Use after set\+Options() to reset AT-\/\+Cmd behaviors to default settings. \mbox{\Hypertarget{ltemc-atcmd_8c_ad19d2388cd6d4423be873314968de031}\label{ltemc-atcmd_8c_ad19d2388cd6d4423be873314968de031}} 
...
\hline
\end{DoxyParams}
\mbox{\Hypertarget{ltemc-atcmd_8c_a12f91584f62bec59a930301de9d7956f}\label{ltemc-atcmd_8c_a12f91584f62bec59a930301de9d7956f}} 
\index{ltemc-\/atcmd.c@{ltemc-\/atcmd.c}!atcmd\_setDataHandler@{atcmd\_setDataHandler}}
\index{atcmd\_setDataHandler@{atcmd\_setDataHandler}!ltemc-\/atcmd.c@{ltemc-\/atcmd.c}}
...
Set/clear stream data receiver function. \mbox{\Hypertarget{ltemc-atcmd_8c_afda91677e5d2defb3af2f63caf2b31a2}\label{ltemc-atcmd_8c_afda91677e5d2defb3af2f63caf2b31a2}} 
...
Resets at\+Cmd struct and optionally releases lock, a BGx AT command structure. \mbox{\Hypertarget{ltemc-atcmd_8c_aabe561361875acf197304759838af23a}\label{ltemc-atcmd_8c_aabe561361875acf197304759838af23a}} 
\index{ltemc-\/atcmd.c@{ltemc-\/atcmd.c}!ATCMD\_testResponseTrace@{ATCMD\_testResponseTrace}}
\index{ATCMD\_testResponseTrace@{ATCMD\_testResponseTrace}!ltemc-\/atcmd.c@{ltemc-\/atcmd.c}}
...
LTEmC internal testing parser to capture incoming response until timeout. 

LTEmC internal testing parser to capture incoming response until timeout. This is generally not used by end-\/user applications. \mbox{\Hypertarget{ltemc-atcmd_8c_a1f90e8d6a28fc9f55520566a869d062a}\label{ltemc-atcmd_8c_a1f90e8d6a28fc9f55520566a869d062a}} 
...
\end{DoxyReturn}
\mbox{\Hypertarget{ltemc-atcmd_8c_a6276c3a16859ccf82f39f00c42fd3b3b}\label{ltemc-atcmd_8c_a6276c3a16859ccf82f39f00c42fd3b3b}} 
