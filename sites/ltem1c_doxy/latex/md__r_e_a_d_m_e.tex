Loo\+UQ Circuit River L\+T\+Em1 modem driver implemented in C99 for portability and a small footprint.\hypertarget{md__r_e_a_d_m_e_autotoc_md1}{}\doxysection{\#\# Pre-\/\+Release -\/ v0.\+3 (release candidate)}\label{md__r_e_a_d_m_e_autotoc_md1}
...
Each test shows the process for initializing, starting services, and a loop exercising the functionality of the subsystem under test.\hypertarget{md__r_e_a_d_m_e_autotoc_md4}{}\doxysubsection{L\+T\+Em1 Subsystems}\label{md__r_e_a_d_m_e_autotoc_md4}
\tabulinesep=1mm
...
\end{longtabu}
\hypertarget{md__r_e_a_d_m_e_autotoc_md5}{}\doxysection{Stay Tuned, Greg}\label{md__r_e_a_d_m_e_autotoc_md5}
