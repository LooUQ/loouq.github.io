Loo\+UQ Circuit River L\+T\+Em1 modem driver implemented in C99 for portability and a small footprint.\hypertarget{md_readme_autotoc_md1}{}\doxysection{\#\# Pre-\/\+Release -\/ v0.\+3 (release candidate)}\label{md_readme_autotoc_md1}
...
All of the core (blue) subsystems are functional. Extension subsystems (copper, with wide-\/borders) are optional and can be built into the application, or omitted to reduced code size. Grey boxes indicate future feature areas.\hypertarget{md_readme_autotoc_md3}{}\doxysection{Getting Started}\label{md_readme_autotoc_md3}
...
Each test shows the process for initializing, starting services, and a loop exercising the functionality of the subsystem under test.\hypertarget{md_readme_autotoc_md4}{}\doxysubsection{L\+T\+Em1 Subsystems}\label{md_readme_autotoc_md4}
\tabulinesep=1mm
...
\end{longtabu}
\hypertarget{md_readme_autotoc_md5}{}\doxysection{Stay Tuned, Greg}\label{md_readme_autotoc_md5}
