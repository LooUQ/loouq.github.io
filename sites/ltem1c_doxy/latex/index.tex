...
\hypertarget{index_autotoc_md1}{}\doxysubsection{Release Status\+: v0.\+3 (release candidate)}\label{index_autotoc_md1}
...
{\bfseries{1st off, thanks for taking a look at the L\+T\+Em1 hardware and L\+T\+Em1c software!}}\hypertarget{index_autotoc_md2}{}\doxysubsection{Getting Started}\label{index_autotoc_md2}
The best way to get started understanding L\+T\+Em1c and considering it for your projects {\bfseries{today}} is to look at the tests folder in the repository. This will be supplemented in the coming weeks. We are working on getting the source code documented with a more complete suite of {\itshape doxygen} markdown tags. We are also adding a couple real world example projects soon. The tests folder contains a series of progressive L\+T\+Em1c tests. Starting with simple platform I/O verification, thru M\+Q\+TT protocol support. Each test builds on a succesful previous level test. Each test can serve as a template for you to start your implementation from.

Each test shows the process for initializing, starting services, and a loop exercising the functionality of the subsystem under test.\hypertarget{index_autotoc_md3}{}\doxysubsubsection{L\+T\+Em1c Subsystems}\label{index_autotoc_md3}
\tabulinesep=1mm
