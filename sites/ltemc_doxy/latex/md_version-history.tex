...
\hypertarget{md_version-history_autotoc_md37}{}\doxysection{v2.\+3.\+0}\label{md_version-history_autotoc_md37}
\hypertarget{md_version-history_autotoc_md38}{}\doxysubsection{Moved radio access technology (\+R\+A\+T) functions to network}\label{md_version-history_autotoc_md38}
...
\end{DoxyItemize}\hypertarget{md_version-history_autotoc_md39}{}\doxysection{v2.\+2.\+0}\label{md_version-history_autotoc_md39}
\hypertarget{md_version-history_autotoc_md40}{}\doxysubsection{Enhancements to network module for specification of A\+P\+N name, P\+D\+P I\+P type (v4\textbackslash{}v6\textbackslash{}both) username\textbackslash{}password, authentication method}\label{md_version-history_autotoc_md40}
...
\end{DoxyItemize}
\end{DoxyItemize}\hypertarget{md_version-history_autotoc_md41}{}\doxysubsubsection{Breaking Changes}\label{md_version-history_autotoc_md41}
...
\end{DoxyItemize}
\end{DoxyItemize}\hypertarget{md_version-history_autotoc_md42}{}\doxysection{v2.\+1.\+1}\label{md_version-history_autotoc_md42}
\hypertarget{md_version-history_autotoc_md43}{}\doxysubsection{Fixes to H\+T\+T\+P and network modules}\label{md_version-history_autotoc_md43}
...
\end{DoxyItemize}\hypertarget{md_version-history_autotoc_md44}{}\doxysection{v2.\+1.\+0}\label{md_version-history_autotoc_md44}
\hypertarget{md_version-history_autotoc_md45}{}\doxysubsection{Fixes and minor enhancements}\label{md_version-history_autotoc_md45}
...
\end{DoxyItemize}\hypertarget{md_version-history_autotoc_md46}{}\doxysubsubsection{Breaking Changes}\label{md_version-history_autotoc_md46}
...
\end{DoxyItemize}\hypertarget{md_version-history_autotoc_md47}{}\doxysection{v2.\+0.\+0 -\/ Major long-\/term release}\label{md_version-history_autotoc_md47}
\hypertarget{md_version-history_autotoc_md48}{}\doxysubsection{Added H\+T\+T\+P(\+S) functionality and redesigned buffering model. Enhancements to A\+T-\/\+Command module to allow for continued extensions to supported features.}\label{md_version-history_autotoc_md48}
...
\end{DoxyItemize}\hypertarget{md_version-history_autotoc_md49}{}\doxysection{v1.\+0.\+0 -\/ M\+A\+J\+O\+R R\+E\+L\+E\+A\+SE}\label{md_version-history_autotoc_md49}
\hypertarget{md_version-history_autotoc_md50}{}\doxysubsection{Version 1.\+0.\+0 is a major release with several breaking changes. This release is the 1st version fully vetted in commercial projects and sets the stage for future multiple Loo\+U\+Q L\+T\+E modem models.}\label{md_version-history_autotoc_md50}
...
\item Misc fixes
\end{DoxyItemize}\hypertarget{md_version-history_autotoc_md51}{}\doxysection{v0.\+5.\+0 -\/ Fixes and Network P\+D\+P context handling (\+Dec 28, 2020)}\label{md_version-history_autotoc_md51}
...
\end{DoxyItemize}\hypertarget{md_version-history_autotoc_md52}{}\doxysection{0.\+4.\+2 (\+Dec 15, 2020)}\label{md_version-history_autotoc_md52}
...
\end{DoxyItemize}\hypertarget{md_version-history_autotoc_md53}{}\doxysection{v0.\+4.\+2 -\/ Misc (\+Dec-\/15-\/2020)}\label{md_version-history_autotoc_md53}
...
\item Removed utils.\+c from L\+T\+Em1c library
\item Functionality is now part of LQ Cloud but can be used independently as lqc\+\_\+collections (.h.c)
\end{DoxyItemize}\hypertarget{md_version-history_autotoc_md54}{}\doxysection{v0.\+4.\+1 -\/ Misc (\+Nov 28, 2020)}\label{md_version-history_autotoc_md54}

\begin{DoxyItemize}
\item Remove dependency on J\+Link R\+TT
\item Fixed parse issue in G\+N\+SS get\+Location()
\end{DoxyItemize}\hypertarget{md_version-history_autotoc_md55}{}\doxysection{v0.\+3 -\/ I\+O\+P Redesign (\+Oct 6, 2020)}\label{md_version-history_autotoc_md55}
...
\end{DoxyItemize}
\item Multiple fixes
\end{DoxyItemize}\hypertarget{md_version-history_autotoc_md56}{}\doxysection{v0.\+2 -\/ Fixes and Enhancements (\+Jun 25, 2020)}\label{md_version-history_autotoc_md56}
...
\end{DoxyItemize}\hypertarget{md_version-history_autotoc_md57}{}\doxysection{v0.\+1 -\/ Initial publish}\label{md_version-history_autotoc_md57}
