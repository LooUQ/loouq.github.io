...
\hypertarget{md_version-history_autotoc_md37}{}\doxysection{v1.\+1.\+0 -\/ Added H\+T\+T\+P(\+S) functionality}\label{md_version-history_autotoc_md37}
...
\item Enabling future I\+OP changes to remove fixed size internal receive buffering, migrating to application owned and managed buffers
\item Enabling future multiple M\+Q\+TT and H\+T\+T\+P(\+S) sessions per modem
\item Enabling future decoupling of M\+Q\+TT and H\+T\+T\+P(\+S) from fixed data contexts (currently\+: M\+Q\+TT=5, H\+T\+TP=4).
\item Misc fixes
\end{DoxyItemize}\hypertarget{md_version-history_autotoc_md38}{}\doxysection{v1.\+0.\+0 -\/ M\+A\+J\+O\+R R\+E\+L\+E\+A\+SE}\label{md_version-history_autotoc_md38}
\hypertarget{md_version-history_autotoc_md39}{}\doxysubsection{Version 1.\+0.\+0 is a major release with several breaking changes. This release is the 1st version fully vetted in commercial projects and sets the stage for future multiple Loo\+U\+Q L\+T\+E modem models.}\label{md_version-history_autotoc_md39}
...
\item Misc fixes
\end{DoxyItemize}\hypertarget{md_version-history_autotoc_md40}{}\doxysection{v0.\+5.\+0 -\/ Fixes and Network P\+D\+P context handling (\+Dec 28, 2020)}\label{md_version-history_autotoc_md40}
...
\end{DoxyItemize}\hypertarget{md_version-history_autotoc_md41}{}\doxysection{0.\+4.\+2 (\+Dec 15, 2020)}\label{md_version-history_autotoc_md41}
...
\end{DoxyItemize}\hypertarget{md_version-history_autotoc_md42}{}\doxysection{v0.\+4.\+2 -\/ Misc (\+Dec-\/15-\/2020)}\label{md_version-history_autotoc_md42}
...
\item Removed utils.\+c from L\+T\+Em1c library
\item Functionality is now part of LQ Cloud but can be used independently as lqc\+\_\+collections (.h.c)
\end{DoxyItemize}\hypertarget{md_version-history_autotoc_md43}{}\doxysection{v0.\+4.\+1 -\/ Misc (\+Nov 28, 2020)}\label{md_version-history_autotoc_md43}

\begin{DoxyItemize}
\item Remove dependency on J\+Link R\+TT
\item Fixed parse issue in G\+N\+SS get\+Location()
\end{DoxyItemize}\hypertarget{md_version-history_autotoc_md44}{}\doxysection{v0.\+3 -\/ I\+O\+P Redesign (\+Oct 6, 2020)}\label{md_version-history_autotoc_md44}
...
\end{DoxyItemize}
\item Multiple fixes
\end{DoxyItemize}\hypertarget{md_version-history_autotoc_md45}{}\doxysection{v0.\+2 -\/ Fixes and Enhancements (\+Jun 25, 2020)}\label{md_version-history_autotoc_md45}
...
\end{DoxyItemize}\hypertarget{md_version-history_autotoc_md46}{}\doxysection{v0.\+1 -\/ Initial publish}\label{md_version-history_autotoc_md46}
