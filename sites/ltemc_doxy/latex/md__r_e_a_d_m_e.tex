...
The Loo\+UQ L\+T\+Em1c driver supports the Loo\+UQ Circuit River L\+T\+Em1 L\+TE modem. The L\+T\+Em1 is designed to allow for cost-\/effective cellular communications in embedded systems by supporting L\+TE C\+A\+T-\/\+M1 and L\+TE C\+A\+T-\/\+N\+B1 (N\+B-\/\+I\+OT) communications. The L\+T\+Em1 is certified for use on the Verizon network. Tested on all major US networks and fully compatible with Hologram S\+I\+Ms.
