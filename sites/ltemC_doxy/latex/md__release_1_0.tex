...
Debugging is of course a necessary part of our lives as developers. For those of you using Segger J-\/\+Link products I recommend the R\+TT (real time terminal) functionality the J-\/\+Link software provides. The inclusion of a small macro block makes turning on/off debugging output using J-\/\+Link R\+TT a simple one line change. Loo\+UQ has a Arduino compatible fork of the Segger J-\/\+Link R\+TT source available on Git\+Hub ().
